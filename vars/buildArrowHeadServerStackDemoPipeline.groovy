			...
			stage( "Dockerize Selected Images" )
			{
				steps
				{
					script
					{
						...
						withCredentials(
						[
							string(credentialsId: env.DB-Root-PWD, variable: 'DB_ROOT_PWD'),
							usernamePassword(credentialsId: env.ArrowHead-User-Pwd, usernameVariable: 'DEFAULT_DB_ARROWHEAD_USR', passwordVariable: 'DEFAULT_DB_ARROWHEAD_PSW')
						])
						{
